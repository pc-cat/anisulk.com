          ...
          >
            <div className="flex flex-col gap-8 text-center uppercase tracking-widest text-2xl font-black relative z-10">
              <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }}>
                <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-purple-300 transition-colors">Home</Link>
              </motion.div>
              ...
              <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }}>
                <Link href="#exhibitions" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-purple-300 transition-colors">Exhibitions</Link>
              </motion.div>
