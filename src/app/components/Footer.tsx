  ...
  return (
    <footer id="contact" className="pt-24 pb-8 px-8 overflow-hidden relative">
      ...
      <button
        ...
        onClick={scrollToTop}
        className="w-full relative h-[30vh] md:h-[40vh] flex items-end justify-center overflow-hidden cursor-pointer group appearance-none bg-transparent border-none text-left p-0"
      >
